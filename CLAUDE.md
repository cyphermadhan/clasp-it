...
- ✅ Website: VibeSignals analytics removed (was unused for product decisions; cleaner footprint)
...
- No analytics — VibeSignals was removed in `cleanup` commit. Add back later if/when needed.
